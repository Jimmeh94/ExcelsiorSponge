...
public class CardDescriptor {
    ...
    public Text name, description, type, movement, summon, rarityText;
    ...
    public CardDescriptor(String name, String description, CardType cardType, String movement, String summon, int baseHealth,
        ...
        if(cardType != CardType.AVATAR) {
            ...
            if (description.contains("Effect: ")) {
                this.description = Text.builder().append(Text.of(TextColors.GOLD, "Effect: "))
                        .append(Text.of(TextColors.GRAY, description.split("Effect: ")[1])).build();
            } else {
            ...
            rarityText = Text.builder().append(Text.of(TextColors.GOLD, "Rarity: "), rarity.getText()).build();
    ...
    public enum CardType {
        ...
        DIVINE(Text.of(TextColors.GOLD, "Divine")),
