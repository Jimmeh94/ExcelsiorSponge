...
public abstract class CardBaseTrap extends CardBase {
    ...
    public CardBaseTrap(UUID owner, String name, CardRarity rarity, ItemType material,
                        int materialDamageValue, CardMovement cardMovement, SummonType summonType) {
        super(owner, name, rarity, new StatPower(0, 0), new StatHealth(0, 0),  material, materialDamageValue, cardMovement, summonType);
    }
